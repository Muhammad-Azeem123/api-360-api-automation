...
test.describe('Create Paid BYOK API Product Workflow with Package Plan', () => {

  test('should successfully automate Create Paid BYOK API Product with Package Plan workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
