...
test.describe('Create Paid BYOK API Product Workflow with Request-Based Plan', () => {

  test('should successfully automate Create Paid BYOK API Product with Request-Based Plan workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
