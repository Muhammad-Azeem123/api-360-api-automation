...
test.describe('Publish Paid BYOK API Product Workflow with Endpoint Pricing - Tier', () => {

  test('should successfully automate Create and Publish Paid BYOK API Product with Endpoint Pricing - Tier workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
