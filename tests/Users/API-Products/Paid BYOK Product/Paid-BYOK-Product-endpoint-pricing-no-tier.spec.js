...
test.describe('Create Paid BYOK API Product Workflow with Endpoint Pricing - No Tier', () => {

  test('should successfully automate Create Paid BYOK API Product with Endpoint Pricing - No Tier workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
