...
const projectName = 'Free BYOK Product';
...
test.describe('Publish Free BYOK API Product Workflow', () => {

  test('should successfully automate Create and Publish Free BYOK API Product workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
