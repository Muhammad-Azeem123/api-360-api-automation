...
test.describe('Create Paid API Product Workflow with Endpoint Pricing - Tier', () => {

  test('should successfully automate Create Paid API Product with Endpoint Pricing - Tier workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
