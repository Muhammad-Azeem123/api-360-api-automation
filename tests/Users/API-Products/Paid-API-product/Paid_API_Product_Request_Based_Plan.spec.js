...
test.describe('Create Paid API Product Workflow with Request-Based Plan', () => {

  test('should successfully automate Create Paid API Product with Request-Based Plan workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
