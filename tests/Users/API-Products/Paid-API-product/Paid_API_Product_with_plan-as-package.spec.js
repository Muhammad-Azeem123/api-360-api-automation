...
test.describe('Create Paid API Product Workflow with Package Plan', () => {

  test('should successfully automate Create Paid API Product with Package Plan workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
