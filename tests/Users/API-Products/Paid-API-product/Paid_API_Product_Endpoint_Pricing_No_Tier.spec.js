...
test.describe('Create Paid API Product Workflow with Endpoint Pricing - No Tier', () => {

  test('should successfully automate Create Paid API Product with Endpoint Pricing - No Tier workflow', async () => {
    let categoryId;
    let prefix;
    let projectId;
    let groupId;
